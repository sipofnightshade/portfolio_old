...
<section class="relative mt-20 bg-overlay dark:bg-overlay-d {className}">
  <div class="container mx-auto flex flex-col gap-8 py-28 md:py-40">
    <SectionHeading title="about" />

    <p
      class="xs:text-3xl text-2xl font-semibold leading-tight tracking-tight sm:text-5xl md:text-6xl 2xl:text-7xl"
    >
